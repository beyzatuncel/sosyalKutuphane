    ...
    class ElipseTool : Component
    {
        ...
        public Control TargetControl
        {
            ...
            set
            {
                if (_cntrl != null)
                {
                    // Daha önce atanan kontrol varsa, SizeChanged olayından aboneliği kaldırın.
                ...
                _cntrl = value; // Yeni kontrol atanıyor

                if (_cntrl != null)
                {
                    // Yeni kontrol atanırsa, SizeChanged olayına yeniden abone olun
                    _cntrl.SizeChanged += (sender, eventArgs) => _cntrl.Region = Region.FromHrgn(CreateRoundRectRgn(0, 0, _cntrl.Width, _cntrl.Height, _CornerRadius, _CornerRadius));
                }
            }
